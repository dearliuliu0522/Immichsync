...
if [[ -d "$BUILD_DIR_UNIVERSAL/$RESOURCE_BUNDLE_NAME" ]]; then
  cp -R "$BUILD_DIR_UNIVERSAL/$RESOURCE_BUNDLE_NAME" "$RESOURCES_DIR/$RESOURCE_BUNDLE_NAME"
elif [[ -d "$BUILD_DIR_ARM/$RESOURCE_BUNDLE_NAME" ]]; then
  cp -R "$BUILD_DIR_ARM/$RESOURCE_BUNDLE_NAME" "$RESOURCES_DIR/$RESOURCE_BUNDLE_NAME"
elif [[ -d "$BUILD_DIR_X64/$RESOURCE_BUNDLE_NAME" ]]; then
  cp -R "$BUILD_DIR_X64/$RESOURCE_BUNDLE_NAME" "$RESOURCES_DIR/$RESOURCE_BUNDLE_NAME"
fi
